...
<head>
    ...
    <title>로그인</title>
    <%-- TODO 전체 공통 cdn 이렇게 했는데 다른 방법이 있나? --%>
...
<main class="login-wrap">
    <form method="post" id="login-form">
        ...
        <div>
            ...
            <input type="email" name="email" id="email" maxlength="50" minlength="0" value="${userLoginVo.email}" data-regex="<%= UserService.Regex.EMAIL %>>" placeholder="이메일" autofocus>
        </div>
        <div>
